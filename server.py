...
import random # Used to select a random dictionary from Levels array
import sys    # Required for exiting loops based on keyboard interrupt

PORT = 33000    #Arbitrary port number assigned for socket communication (For Pi between 33000 - 34000)
...
s.bind((socket.gethostname(),PORT))                 # Binding the socket to a the previously declared port
